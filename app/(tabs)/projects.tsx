...
• Implemented image normalization and subject classification with boundary frame display.`,
            ...
            github: 'https://github.com/dab07/pokeVerse',
            image: '',
            technologies: ['AIML Model', 'HAAR Cascading', 'OpenCV'],
            videoDemo: '',
            color: ['#8B5CF6', '#EC4899'],
        },
    ];
                    ...
                    >
                        ...
                        <View className="p-4 pb-3">
                            <View className="flex-row items-center justify-between mb-3">
                                ...
                                <Pressable
                                    className="bg-gray-800/60 p-2.5 rounded-full border border-gray-600/50"
                                    onPress={(e) => {
                                        e.stopPropagation();
                        ...
                        {/* Project Image */}
                        <View className="mx-4 mb-4 rounded-xl overflow-hidden border border-purple-500/20">
                            <Image
